...
fun MainView(){
    ...
    // on which view are we currently are
                ...
                screensInBottom.forEach {
                    ...
                    BottomNavigationItem(selected = currentRoute == item.bRoute,
                        onClick = {controller.navigate(item.bRoute)
                            title.value=item.bTittle
                                  }, icon = {

                            Icon(tint = tint,
                                contentDescription = item.bTittle,
                                painter = painterResource(id=item.icon)
                            )
                        },
                        label={Text(text = item.bTittle,color=tint)},
    ...
    ModalBottomSheetLayout(sheetState = modalSheetState,
        ...
        Scaffold(
            ...
            AccountDialog(dialogueOpen =dialogOpen)
        }
    }
    ...
    Box(
        ...
        Column(modifier=Modifier.padding(16.dp), verticalArrangement =Arrangement.SpaceBetween) {
            Row(modifier=Modifier.padding(16.dp)) {
                ...
                Text(text="Settings",style=MaterialTheme.typography.h5, fontSize = 20.sp,color=Color.White)
            }
        }
    }
}
